...
> This project adopts the [Contributor Covenant](https://www.contributor-covenant.org) v2.1. Official translations (including 中文) are at <https://www.contributor-covenant.org/translations>. Report violations via the repo's [GitHub private security advisory](https://github.com/Quinn-Talor/talor/security/advisories/new) (see [SECURITY.md](./SECURITY.md)).
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the community leaders responsible for enforcement via the project's [GitHub private security advisory](https://github.com/Quinn-Talor/talor/security/advisories/new). All complaints will be reviewed and investigated promptly and fairly.
...
2. **Warning** — Community Impact: A violation through a single incident or series of actions. Consequence: A warning with consequences for continued behavior. No interaction with the people involved for a specified period of time.
