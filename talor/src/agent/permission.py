...
This module provides the permission system following opencode's PermissionNext pattern.
...
class PermissionRule(BaseModel):
    ...
    Corresponds to opencode's PermissionNext rule.
...
class Permission:
    ...
    Corresponds to opencode's PermissionNext namespace.
    """
    ...
    def from_config(config: dict[str, Any]) -> Ruleset:
        ...
        Corresponds to opencode's PermissionNext.fromConfig().
    ...
    def merge(*rulesets: Ruleset) -> Ruleset:
        ...
        Corresponds to opencode's PermissionNext.merge().
