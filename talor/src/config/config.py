...
This module provides configuration management following opencode's Config pattern.
...
class ConfigInfo(BaseModel):
    ...
    Corresponds to opencode's Config.Info.
    """
...
class Config:
    ...
    Corresponds to opencode's Config namespace.
    """
    ...
    async def get(cls) -> dict[str, Any]:
        ...
        Corresponds to opencode's Config.get().
    ...
    async def set(cls, key: str, value: Any, scope: str = "project") -> None:
        ...
        # Publish event
        if cls._bus:
            from talor.bus.events import ConfigChanged, ConfigChangedData
