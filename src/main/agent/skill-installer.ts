// src/main/agent/skill-installer.ts — 业务层:Schema 1.0 v8.1 skill 自动安装
//
// v8.1: SkillItem 是 flat 形态 { name, required, purpose? }—— 没有 source 字段。
...
//
// 用户痛点:profile.method.skills 声明依赖,但 SKILL.md 不在 <root>/skills/<name>/
...
/**
 * 为 agent 安装 method.skills 中声明的 skill 包到 <agentDir>/skills/<name>/.
